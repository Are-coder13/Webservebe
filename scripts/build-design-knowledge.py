...
const DOMAIN_SIGNALS = {
  ...
  beauty: ['grillz', 'kristal', 'tandkristal', 'bluetoothgem', 'beauty', 'salon', 'spa',
           'schoonheid', 'schoonheidsspecialist', 'schoonheidssalon', 'nagel', 'nagels', 'nagelstudio',
           'kapper', 'kapsalon', 'haar', 'barber', 'wellness', 'massage', 'esthetiek', 'esthetique',
           'brow', 'lash', 'wimper', 'wenkbrauw', 'pedicure', 'manicure', 'visagie', 'make-up', 'makeup',
           'cosmetic', 'cosmetica', 'huid', 'huidverzorging', 'parfum', 'parfumerie', 'parfumeur',
           'perfume', 'tanning', 'zonnebank', 'permanent', 'aesthetic', 'skincare'],
